<template>
  <div class="login" id="form" ref="backGroundColor">
    ...
    <div class="login_form" v-if="form_show">
      <van-field v-model="name" left-icon="user-o" placeholder="伍燕文" label-width="36px" />
      <van-field v-model="college" left-icon="home-o" placeholder="软件学院" label-width="36px" />
      <div class="scroll">
...
export default {
  ...
  setup() {
    ...
    let info = ref('')
    info.value = '富强'
    const columns = ['富强', '民主', '文明', '和谐', '自由', '诚信', '敬业', '友善', '平等', '公正', '法治', '爱国', '明德', '至诚', '远志', '博学']
    const onConfirm = () => {}
